...
int main(int argc, char *argv[]) {
	...
	for (int i = 0; i < dancingRobot.meshes.size(); i++) {
		glDeleteBuffers(1, &dancingRobot.meshes[i].vbo);
		glDeleteVertexArrays(1, &dancingRobot.meshes[i].vao);
		glDeleteBuffers(1, &dancingRobot.meshes[i].ebo);
	}
